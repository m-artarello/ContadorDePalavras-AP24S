...
//      ------------------------ CONTAGEM PARALELA ------------------------
        ...
        // Comparacao para saber se os resultados sao iguais
...
//      ------------------------ SPEED UP ------------------------
        ...
        System.out.println("--- ANÁLISE DE SPEED-UP ---");
        ...
        System.out.printf("----------------------|----------------|----------------------|-----------------------%n");
        System.out.printf("%21d | %14.3f | %20.2f | %22.2f%n", 1, T1, 1.0, 1.0); // Resultado serial
